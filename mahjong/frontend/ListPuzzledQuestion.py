...
from . import Home
import ast
from . import PuzzledResult
from . import CreatePuzzledQuestion

class ListPuzzledQuestion:
    ...
    def delete_button_clicked(self, event):
        ...
        for i in self.page_buttons:
            i.destroy()
        with open("../puzzled_question.txt", 'w' ) as ms:
    ...
    def answer_button_clicked(self, event):
        ...
        for i in self.page_buttons:
            i.destroy()
        PuzzledResult.puzzled_result(self.canvas, self.root, question, yaku)
    ...
    def create_button_clicked(self):
        ...
        for i in self.page_buttons:
            i.destroy()
        self.canvas.place_forget()
        cmq = CreatePuzzledQuestion.CreatePuzzledQuestion()
    ...
    def show_list(self, canvas, root):
        ...
        with open("../puzzled_question.txt", 'r' ) as ms:
